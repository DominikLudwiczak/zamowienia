...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-md-8 mx-auto">
        ...
        <?php echo csrf_field(); ?>
            ...
            <div class="mt-3">
                <a href="<?php echo e(session('url') ?? URL::previous()); ?>" class="btn btn-primary">Cofnij</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zamowienia/laravel/resources/views/calendar/holidays/holiday.blade.php ENDPATH**/ ?>