    ...
    <div class="mx-auto" style="height:100%;">
        <ul class="nav flex-column mx-2" style='font-size: 0.9rem;'>
            @if(Gate::allows('admin'))
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" id='employees' href="{{ route('employees_admin') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" id='summary' href="{{ route('summaries') }}">
                        <img src="{{ asset('img/summary.svg') }}"/>
                        Podsumowania
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" id='suppliers' href="{{ route('suppliers') }}">
                        <img src="{{ asset('img/suppliers.svg') }}"/>
                        Dostawcy
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <img src="{{ asset('img/store.svg') }}"/>
                        Sklepy
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" id='scheduler' href="{{ route('scheduler_admin') }}">
            ...
            @else
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" id='scheduler' href="{{ route('scheduler_user') }}">
                        <img src="{{ asset('img/calendar.svg') }}"/>
                        Grafik
                    </a>
                </li>
            ...
            <li class="nav-item">
                <a class="nav-link text-white" id='requests' href="{{ route('requests') }}">
                    <img src="{{ asset('img/interview.svg') }}"/>
                    Wnioski
                </a>
            </li>
        </ul>
