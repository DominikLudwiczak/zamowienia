                    ...
                    @foreach($products as $product)
                        ...
                        <tr>
                            ...
                            <td>{{$product->name}}</td>
                                ...
                                ?>
                            <td><div class='col-sm-12 col-md-4 mx-auto'><input type='number' name="product_{{$product->id}}" oninput="set_ammount({{$product->id}})" min="1" step=".01" value="{{$ammount ?? ''}}" class='form-control'/></div></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
