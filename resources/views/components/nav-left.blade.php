<!-- <div id='wrapper' class='shadow-lg vh-100' style='background-color: #1D65B7;'>
    <ul class='navbar-nav' style='color:#E1E1E1; font-size:1.1rem;'>
        <li class='nav-item pt-2'>Dostawcy</li>
        <li class='nav-item pt-2'>Wysłane</li>
        <li class='nav-item p-2'>test</li>
    </ul>
</div> -->
<div class='container vh-100 p-2' style='background-color: #1D65B7;'>
    <div class="sidebar-sticky">
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link text-white" style="text-decoration: underline;" href="#">
