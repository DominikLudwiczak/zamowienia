...
<table class="table table-striped text-center mt-4 table-responsive-sm" style="min-width:100%">
    ...
    <div class="modal fade" tabindex="-1" role="dialog" role="dialog" id="delete" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title">Czy na pewno chcesz usunąć ten produkt?</h5>
